...
public class ContactActivity extends AppCompatActivity {
        ...
        StringRequest stringRequest = new StringRequest(url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Prefs.putString("station", response);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("ติดต่อโรงพยาบาล");
        view_contact = (View)findViewById(R.id.layout_contact) ;

        final String url_contact = Prefs.getString("api_url","")+"frontend/web/index.php/data/station";


        mwebView = (WebView)findViewById(R.id.web_contact);
        ...
        mwebView.loadData(Prefs.getString("station",""),"text/html; charset=utf-8", "UTF-8");
